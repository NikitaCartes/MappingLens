...
6. **Операционное.** Ввести миграцию схемы или версионирование индекса, чтобы устаревший `mappinglens.db`
   не приводил к 500 — сейчас единственное лечение — пересборка через `index`.
